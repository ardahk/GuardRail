...
const statusConfig: Record<LaneStatus, { label: string; bg: string; text: string; dot: string }> = {
  ...
  pivoted: { label: 'Pivoted', bg: 'bg-cyan-500/20', text: 'text-cyan-300', dot: 'bg-cyan-400' },
  escalated: { label: 'Escalated', bg: 'bg-orange-500/20', text: 'text-orange-300', dot: 'bg-orange-400' },
